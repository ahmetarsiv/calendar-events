...
The following API allows interaction with both iOS and Android device calendars.
...
If you encounter something that is not listed here, try [searching in GitHub issues of `react-native-calendar-events`](https://github.com/ahmetarsiv/calendar-events/issues).
